...
Route::namespace('Client')->prefix('/')->group(function () {
    Route::namespace('Auth')->prefix('auth')->group(function () {
        ...
        // Social Login
        Route::get('/oauth/{driver}', 'SocialLoginController@redirectToProvider')->name('auth.social.oauth');
        Route::get('/oauth/{driver}/callback', 'SocialLoginController@handleProviderCallback')->name('auth.social.callback');
    });
